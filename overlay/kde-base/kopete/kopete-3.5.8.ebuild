...
SRC_URI="${SRC_URI}
	mirror://gentoo/kdenetwork-3.5-patchset-01.tar.bz2 http://kdemod.ath.cx/source/kopete-reloading-kit/kopete-reloading-images.tar.gz"
...
src_unpack() {
	...
	epatch "${FILESDIR}/kdemod/04_kopete-reloading-kit.patch"
	epatch "${FILESDIR}/kdemod/05_kopete-emoticons-manager.patch"
	epatch "${FILESDIR}/kdemod/06_kopete-fix-extra-line-break-in-jabber.patch"
	epatch "${FILESDIR}/kdemod/07_kopete-fix-newlines-when-sending-richtext-icq.patch"
	epatch "${FILESDIR}/kdemod/08_kopete-show-previous-status-messages.patch"
	epatch "${FILESDIR}/kdemod/09_kopete-fix-translation-plugin.patch"
